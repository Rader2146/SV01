...
#define CUSTOM_MACHINE_NAME "SV01"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -33.5, -3.5, -1.2 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 36, 35, 36, 35 } // (mm) Left, Front, Right, Back insets
